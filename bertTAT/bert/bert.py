...
from bertTAT.pos_embd import PositionEmbedding
from bertTAT.layer_normalization import LayerNormalization
from bertTAT.transformer import get_encoders
from bertTAT.transformer import get_custom_objects as get_encoder_custom_objects
...
def gen_batch_inputs(sentence_pairs,
    ...
    if swap_sentence_rate > 0.0:
        # indices的产生和swap_sentence_rate有关
